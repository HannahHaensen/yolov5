    ...
    for elem_i in data["images"]:
        ...
        if os.path.exists(source_path):
            ...
            if index <= threshold[0]:
                # print(source_path)
                shutil.copy(source_path, dataset_destination + "images/train")
...
if __name__ == '__main__':
    ...
    dataset_origin = "D:/BlenderProc_dataset3/output/coco_data/"
